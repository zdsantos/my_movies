  ...
  group(
    ...
    () {
      test('Get single movie', () async {
        ...
        var result = await service.getMovie(550, language: LanguageCode.en_US);
        ...
        expect(result.productionCountries.any((c) => c.iso_3166_1 == "US"),
            isTrue);
        expect(result.spokenLanguages.any((c) => c.iso_639_1 == "en"), isTrue);
        expect(result.spokenLanguages.any((c) => c.iso_639_1 == "en"), isTrue);

        var resultPt =
            await service.getMovie(550, language: LanguageCode.pt_BR);
